...
**python main.py 1.wav 8909055555 1 stage-1**
    ...
    stage-1 или stage-2 - этапы распознования. stage-1 - Обрабатывает результат,если в аудио записи распознан автоответчик возвращает 0. Если человек, возвращает 
    1. stage-1 -
